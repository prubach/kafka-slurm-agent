...
app = faust.App(config.get('MONITOR_AGENT_APP_NAME', config['MONITOR_AGENT_NEW_GROUP'] if 'MONITOR_AGENT_NEW_GROUP' in config else socket.gethostname() + '_monitor_agent_new'),
                group_id=1,
